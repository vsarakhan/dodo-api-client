...
T = TypeVar("T", bound="GetLocalSuppliersResponse200")


@_attrs_define
class GetLocalSuppliersResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_local_suppliers_response_200 = cls(
            suppliers=suppliers,
            is_end_of_list_reached=is_end_of_list_reached,
        )

        get_local_suppliers_response_200.additional_properties = d
        return get_local_suppliers_response_200
