...
if TYPE_CHECKING:
    from ..models.unit_shift import UnitShift


T = TypeVar("T", bound="GetUnitShiftsResponse200")


@_attrs_define
class GetUnitShiftsResponse200:
    """
    Attributes:
        shifts (List['UnitShift']): Смены заведений
        is_end_of_list_reached (bool): Индикатор того, что достигнут конец списка. Выдаёт true, если достигнут конец
            списка.
    """

    shifts: List["UnitShift"]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for shifts_item_data in _shifts:
            shifts_item = UnitShift.from_dict(shifts_item_data)

            shifts.append(shifts_item)

        is_end_of_list_reached = d.pop("isEndOfListReached")

        get_unit_shifts_response_200 = cls(
            shifts=shifts,
            is_end_of_list_reached=is_end_of_list_reached,
        )

        get_unit_shifts_response_200.additional_properties = d
        return get_unit_shifts_response_200
