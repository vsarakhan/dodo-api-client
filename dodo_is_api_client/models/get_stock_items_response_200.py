...
T = TypeVar("T", bound="GetStockItemsResponse200")


@_attrs_define
class GetStockItemsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_stock_items_response_200 = cls(
            stock_items=stock_items,
            is_end_of_list_reached=is_end_of_list_reached,
        )

        get_stock_items_response_200.additional_properties = d
        return get_stock_items_response_200
