...
if TYPE_CHECKING:
    from ..models.product_write_off import ProductWriteOff


T = TypeVar("T", bound="GetWriteOffProductsResponse200")


@_attrs_define
class GetWriteOffProductsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for write_offs_item_data in _write_offs:
            write_offs_item = ProductWriteOff.from_dict(write_offs_item_data)

            write_offs.append(write_offs_item)

        is_end_of_list_reached = d.pop("isEndOfListReached")

        get_write_off_products_response_200 = cls(
            write_offs=write_offs,
            is_end_of_list_reached=is_end_of_list_reached,
        )

        get_write_off_products_response_200.additional_properties = d
        return get_write_off_products_response_200
