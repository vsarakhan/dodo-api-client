...
from ...models.get_delivery_stop_sales_sectors_response_200 import GetDeliveryStopSalesSectorsResponse200
...
) -> Optional[Union[Any, GetDeliveryStopSalesSectorsResponse200]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetDeliveryStopSalesSectorsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetDeliveryStopSalesSectorsResponse200]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Стопы сгруппированы по пиццериям и секторам.
    ...
    4. Начальная дата периода `to` - не раньше 1 апреля 2023 года.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetDeliveryStopSalesSectorsResponse200]
    """
