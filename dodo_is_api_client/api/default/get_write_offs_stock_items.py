...
from ...models.get_write_offs_stock_items_response_200 import GetWriteOffsStockItemsResponse200
from ...models.get_write_offs_stock_items_response_400 import GetWriteOffsStockItemsResponse400
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/accounting/write-offs/stock-items",
        "params": params,
    }
...
) -> Optional[Union[Any, GetWriteOffsStockItemsResponse200, GetWriteOffsStockItemsResponse400]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetWriteOffsStockItemsResponse200.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.BAD_REQUEST:
        response_400 = GetWriteOffsStockItemsResponse400.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetWriteOffsStockItemsResponse200, GetWriteOffsStockItemsResponse400]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Учёт → Списанное сырье

     Возвращает списанное сырье за указанный период (включительно), отсортированное по дате списания.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetWriteOffsStockItemsResponse200, GetWriteOffsStockItemsResponse400]
    """
