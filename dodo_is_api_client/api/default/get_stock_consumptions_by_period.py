...
from ...models.get_stock_consumptions_by_period_response_200 import GetStockConsumptionsByPeriodResponse200
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/accounting/stock-consumptions-by-period",
        "params": params,
    }
...
) -> Optional[Union[Any, ErrorContract, ErrorContractBadRequest, GetStockConsumptionsByPeriodResponse200]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetStockConsumptionsByPeriodResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorContract, ErrorContractBadRequest, GetStockConsumptionsByPeriodResponse200]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Учёт → Расход сырья за период
     ...
     Возвращает расход сырья за указанный период (включительно), сгруппированный по идентификатору
    заведения, идентификатору сырья, типу расхода и единице измерения и отсортированный по
    идентификатору заведения, типу расхода и идентификатору сырья.
    ...
    Данные в ответе API могут отличаться от аналогиченого отчета в Dodo IS. Данное API возвращает только
    данные о расходе сырья и не учитывает перемещение.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorContract, ErrorContractBadRequest, GetStockConsumptionsByPeriodResponse200]
    """
