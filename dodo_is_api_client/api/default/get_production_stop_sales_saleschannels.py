...
from ...models.get_production_stop_sales_saleschannels_response_200 import (
...
) -> Optional[Union[Any, GetProductionStopSalesSaleschannelsResponse200]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetProductionStopSalesSaleschannelsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetProductionStopSalesSaleschannelsResponse200]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Стопы сгруппированы по пиццериям и каналам продаж: доставка, самовывоз, ресторан.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetProductionStopSalesSaleschannelsResponse200]
    """
