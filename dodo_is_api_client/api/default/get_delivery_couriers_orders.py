...
from ...models.get_delivery_couriers_orders_response_200 import GetDeliveryCouriersOrdersResponse200
...
) -> Optional[GetDeliveryCouriersOrdersResponse200]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetDeliveryCouriersOrdersResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[GetDeliveryCouriersOrdersResponse200]:
    return Response(
