...
from ...models.get_defective_products_response_200 import GetDefectiveProductsResponse200
from ...models.get_defective_products_response_400 import GetDefectiveProductsResponse400
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/accounting/defective-products",
        "params": params,
    }
...
) -> Optional[Union[Any, GetDefectiveProductsResponse200, GetDefectiveProductsResponse400]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetDefectiveProductsResponse200.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.BAD_REQUEST:
        response_400 = GetDefectiveProductsResponse400.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetDefectiveProductsResponse200, GetDefectiveProductsResponse400]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Учёт → Забракованные продукты
     ...
     Возвращает забракованные продукты за указанный период (включительно), отсортированные по дате и
    идентификатору продажи.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetDefectiveProductsResponse200, GetDefectiveProductsResponse400]
    """
