...
from ...models.get_unit_shifts_response_200 import GetUnitShiftsResponse200
from ...models.get_unit_shifts_response_400 import GetUnitShiftsResponse400
...
) -> Optional[Union[Any, GetUnitShiftsResponse200, GetUnitShiftsResponse400]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetUnitShiftsResponse200.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.BAD_REQUEST:
        response_400 = GetUnitShiftsResponse400.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetUnitShiftsResponse200, GetUnitShiftsResponse400]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Заведения → Смены заведений
     ...
     Возвращает список смен заведений, отсортированный по дате начала смены. Смены выбираются по времени
    начала (eсли начало смены попало в диапазон from – to включительно).
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetUnitShiftsResponse200, GetUnitShiftsResponse400]
    """
