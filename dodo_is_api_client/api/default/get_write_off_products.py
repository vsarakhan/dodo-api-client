...
from ...models.get_write_off_products_response_200 import GetWriteOffProductsResponse200
from ...models.get_write_off_products_response_400 import GetWriteOffProductsResponse400
...
def _get_kwargs(
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": "/accounting/write-offs/products",
        "params": params,
    }
...
) -> Optional[Union[Any, GetWriteOffProductsResponse200, GetWriteOffProductsResponse400]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetWriteOffProductsResponse200.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.BAD_REQUEST:
        response_400 = GetWriteOffProductsResponse400.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetWriteOffProductsResponse200, GetWriteOffProductsResponse400]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Учёт → Списанные продукты
     ...
     Возвращает списанные продукты за указанный период (включительно), отсортированные по дате списания.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetWriteOffProductsResponse200, GetWriteOffProductsResponse400]
    """
