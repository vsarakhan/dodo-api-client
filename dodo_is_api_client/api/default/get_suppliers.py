...
from ...models.get_suppliers_response_200 import GetSuppliersResponse200
from ...models.get_suppliers_response_400 import GetSuppliersResponse400
...
) -> Optional[Union[Any, GetSuppliersResponse200, GetSuppliersResponse400]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetSuppliersResponse200.from_dict(response.json())

        return response_200
    if response.status_code == HTTPStatus.BAD_REQUEST:
        response_400 = GetSuppliersResponse400.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetSuppliersResponse200, GetSuppliersResponse400]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Учет → Список поставщиков

     Возвращает список поставщиков, отсортированный ID.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetSuppliersResponse200, GetSuppliersResponse400]
    """
