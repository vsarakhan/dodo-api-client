...
from ...models.get_production_stop_sales_statistics_products_response_200 import (
...
) -> Optional[Union[Any, GetProductionStopSalesStatisticsProductsResponse200]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetProductionStopSalesStatisticsProductsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetProductionStopSalesStatisticsProductsResponse200]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Стопы сгруппированы по пиццериям и продуктам.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetProductionStopSalesStatisticsProductsResponse200]
    """
