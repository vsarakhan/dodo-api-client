...
from ...models.get_applicants_vacancies_count_response_200 import GetApplicantsVacanciesCountResponse200
...
) -> Optional[Union[Any, ErrorContract, ErrorContractBadRequest, GetApplicantsVacanciesCountResponse200]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = GetApplicantsVacanciesCountResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorContract, ErrorContractBadRequest, GetApplicantsVacanciesCountResponse200]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Команда → Количество открытых вакансий
     ...
     Получение количества открытых вакансий в заведениях
...
def sync(
    *,
    ...
    Returns:
        Union[Any, ErrorContract, ErrorContractBadRequest, GetApplicantsVacanciesCountResponse200]
    """
